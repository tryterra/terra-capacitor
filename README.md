...
* [`setUpBackgroundDelivery()`](#setupbackgrounddelivery)
...
| Param         | Type                                                 |
| ------------- | ---------------------------------------------------- |
| **`options`** | <code>{ devId: string; referenceId: string; }</code> |
...
```typescript
getBody(options: { connection: Connections; startDate: Date; endDate: Date; }) => Promise<any>
```

| Param         | Type                                                                                                                                         |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| **`options`** | <code>{ connection: <a href="#connections">Connections</a>; startDate: <a href="#date">Date</a>; endDate: <a href="#date">Date</a>; }</code> |
...
```typescript
getActivity(options: { connection: Connections; startDate: Date; endDate: Date; }) => Promise<any>
```
...
```typescript
getDaily(options: { connection: Connections; startDate: Date; endDate: Date; }) => Promise<any>
```
...
```typescript
getNutrition(options: { connection: Connections; startDate: Date; endDate: Date; }) => Promise<any>
```
...
```typescript
getSleep(options: { connection: Connections; startDate: Date; endDate: Date; }) => Promise<any>
```
