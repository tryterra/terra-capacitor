...
const Camera = registerPlugin$1("Camera", {
  web: () => __vitePreload(() => import("./web.e5a1cf9b.js"), true ? [] : void 0).then((m) => new m.CameraWeb())
});
const SplashScreen = registerPlugin$1("SplashScreen", {
  web: () => __vitePreload(() => import("./web.8e75ffd3.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
/*! Capacitor: https://capacitorjs.com/ - MIT License */
...
(function(CustomPermissions2) {
  CustomPermissions2["WORKOUT_TYPES"] = "WORKOUT_TYPES";
  CustomPermissions2["ACTIVITY_SUMMARY"] = "ACTIVITY_SUMMARY";
  CustomPermissions2["LOCATION"] = "LOCATION";
  CustomPermissions2["CALORIES"] = "CALORIES";
  CustomPermissions2["STEPS"] = "STEPS";
  CustomPermissions2["HEART_RATE"] = "HEART_RATE";
  CustomPermissions2["HEART_RATE_VARIABILITY"] = "HEART_RATE_VARIABILITY";
  CustomPermissions2["VO2MAX"] = "VO2MAX";
  CustomPermissions2["HEIGHT"] = "HEIGHT";
  CustomPermissions2["ACTIVE_DURATIONS"] = "ACTIVE_DURATIONS";
  CustomPermissions2["WEIGHT"] = "WEIGHT";
  CustomPermissions2["FLIGHTS_CLIMBED"] = "FLIGHTS_CLIMBED";
  CustomPermissions2["BMI"] = "BMI";
  CustomPermissions2["BODY_FAT"] = "BODY_FAT";
  CustomPermissions2["EXERCISE_DISTANCE"] = "EXERCISE_DISTANCE";
  CustomPermissions2["GENDER"] = "GENDER";
  CustomPermissions2["DATE_OF_BIRTH"] = "DATE_OF_BIRTH";
  CustomPermissions2["BASAL_ENERGY_BURNED"] = "BASAL_ENERGY_BURNED";
  CustomPermissions2["SWIMMING_SUMMARY"] = "SWIMMING_SUMMARY";
  CustomPermissions2["RESTING_HEART_RATE"] = "RESTING_HEART_RATE";
  CustomPermissions2["BLOOD_PRESSURE"] = "BLOOD_PRESSURE";
  CustomPermissions2["BLOOD_GLUCOSE"] = "BLOOD_GLUCOSE";
  CustomPermissions2["BODY_TEMPERATURE"] = "BODY_TEMPERATURE";
  CustomPermissions2["MINDFULNESS"] = "MINDFULNESS";
  CustomPermissions2["LEAN_BODY_MASS"] = "LEAN_BODY_MASS";
  CustomPermissions2["OXYGEN_SATURATION"] = "OXYGEN_SATURATION";
  CustomPermissions2["SLEEP_ANALYSIS"] = "SLEEP_ANALYSIS";
  CustomPermissions2["RESPIRATORY_RATE"] = "RESPIRATORY_RATE";
  CustomPermissions2["NUTRITION_SODIUM"] = "NUTRITION_SODIUM";
  CustomPermissions2["NUTRITION_PROTEIN"] = "NUTRITION_PROTEIN";
  CustomPermissions2["NUTRITION_CARBOHYDRATES"] = "NUTRITION_CARBOHYDRATES";
  CustomPermissions2["NUTRITION_FIBRE"] = "NUTRITION_FIBRE";
  CustomPermissions2["NUTRITION_FAT_TOTAL"] = "NUTRITION_FAT_TOTAL";
  CustomPermissions2["NUTRITION_SUGAR"] = "NUTRITION_SUGAR";
  CustomPermissions2["NUTRITION_VITAMIN_C"] = "NUTRITION_VITAMIN_C";
  CustomPermissions2["NUTRITION_VITAMIN_A"] = "NUTRITION_VITAMIN_A";
  CustomPermissions2["NUTRITION_CALORIES"] = "NUTRITION_CALORIES";
  CustomPermissions2["NUTRITION_WATER"] = "NUTRITION_WATER";
  CustomPermissions2["NUTRITION_CHOLESTEROL"] = "NUTRITION_CHOLESTEROL";
})(CustomPermissions || (CustomPermissions = {}));
var Permissions;
(function(Permissions2) {
  Permissions2["ACTIVITY"] = "ACTIVITY";
  Permissions2["BODY"] = "BODY";
  Permissions2["DAILY"] = "DAILY";
  Permissions2["NUTRITION"] = "NUTRITION";
  Permissions2["SLEEP"] = "SLEEP";
})(Permissions || (Permissions = {}));
var Connections;
(function(Connections2) {
  Connections2["APPLE_HEALTH"] = "APPLE_HEALTH";
  Connections2["FREESTYLE_LIBRE"] = "FREESTYLE_LIBRE";
  Connections2["GOOGLE"] = "GOOGLE";
  Connections2["SAMSUNG"] = "SAMSUNG";
})(Connections || (Connections = {}));
const Terra = registerPlugin("TerraCapacitor", {
  web: () => __vitePreload(() => import("./web.25e04efb.js"), true ? [] : void 0).then((m) => new m.TerraWeb())
});
window.customElements.define(
  ...
  class extends HTMLElement {
    constructor() {
      ...
      Terra.initTerra({ devId: "testingElliott", referenceId: "referenceid" }).then((res) => {
        console.log("initTerra", res.success);
        Terra.initConnection({
          connection,
          token: "f6bde3520cee5edd30b590ae0db41dea4c48c0a007babe42a3132cc63f21275f",
          schedulerOn: true,
          customPermissions: [],
          startIntent: null
        }).then((a) => {
...
export { CameraSource as C, WebPlugin$1 as W, CameraDirection as a, CapacitorException$1 as b, WebPlugin as c };
